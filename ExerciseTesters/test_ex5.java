...
public class test_ex5 { // RequestParser
    ...
    public static void testServer() throws Exception
    {
        try {
            ...
            server.addServlet("GET", "/calculate", new AddServlet());
            server.addServlet("POST", "/calculate", new AddServlet());
            ...
            try (Socket clientSocket = new Socket("localhost", 8080))
            {
                ...
                String requestGET = "GET /calculate?a=5&b=3 HTTP/1.1\n" +
                        "Host: localhost\n" +
                        "\n";
                String requestPOST = "POST /calculate HTTP/1.1\n" +
                        "Host: localhost\n" +
                        "Content-Type: application/x-www-form-urlencoded\n" +
                        "Content-Length: 7\n" +  // Adjust this based on the length of the body
                        "\n" +
                        "a=5&b=3";

                outputStream.write(requestPOST.getBytes());
            ...
            System.out.println("check count threads: "+check);
    ...
    public static void main(String[] args) {
        ...
        RequestParser.RequestInfo requestInfo = null;
		try {
